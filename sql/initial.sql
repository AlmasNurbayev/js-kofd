...
-- create kassa
CREATE TABLE "public".kassa (id smallint PRIMARY KEY,snumber varchar,znumber varchar,knumber varchar,name varchar,id_organization smallint REFERENCES "public".organization (id));
...
-- create transaction
CREATE TABLE "public".transaction (id varchar,onlineFiscalNumber varchar,offlineFiscalNumber varchar,systemDate timestamptz,operationDate timestamptz,type_operation smallint, subType smallint,sum_operation numeric,availableSum numeric,paymentTypes smallint,shift smallint,id_organization smallint REFERENCES "public".organization (id),id_kassa smallint REFERENCES "public".kassa (id));
ALTER TABLE "public".kassa OWNER TO ps;